...
funcion_principal:
            MAIN '(' ')' '{' bloque_sentencias '}' {
                ...
                $$.code = gen_code(temp);
                vacial_variables_locales();  // Limpiar tabla al salir
                }
            ;
